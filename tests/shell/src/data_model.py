...
class ShellFoundryTest_2(object):
    ...
    def attribute_2(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.attribute_2"] if "ShellFoundryTest_2.attribute_2" in self.attributes else None
        )
    ...
    def enable_password(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.Enable Password"]
            if "ShellFoundryTest_2.Enable Password" in self.attributes
            else None
        )
    ...
    def power_management(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.Power Management"]
            if "ShellFoundryTest_2.Power Management" in self.attributes
            else None
        )
    ...
    def sessions_concurrency_limit(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.Sessions Concurrency Limit"]
            if "ShellFoundryTest_2.Sessions Concurrency Limit" in self.attributes
            else None
        )
    ...
    def snmp_read_community(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.SNMP Read Community"]
            if "ShellFoundryTest_2.SNMP Read Community" in self.attributes
            else None
        )
    ...
    def snmp_write_community(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.SNMP Write Community"]
            if "ShellFoundryTest_2.SNMP Write Community" in self.attributes
            else None
        )
    ...
    def snmp_v3_user(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.SNMP V3 User"]
            if "ShellFoundryTest_2.SNMP V3 User" in self.attributes
            else None
        )
    ...
    def snmp_v3_password(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.SNMP V3 Password"]
            if "ShellFoundryTest_2.SNMP V3 Password" in self.attributes
            else None
        )
    ...
    def snmp_v3_private_key(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.SNMP V3 Private Key"]
            if "ShellFoundryTest_2.SNMP V3 Private Key" in self.attributes
            else None
        )
    ...
    def snmp_v3_authentication_protocol(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.SNMP V3 Authentication Protocol"]
            if "ShellFoundryTest_2.SNMP V3 Authentication Protocol" in self.attributes
            else None
        )
    ...
    def snmp_v3_privacy_protocol(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.SNMP V3 Privacy Protocol"]
            if "ShellFoundryTest_2.SNMP V3 Privacy Protocol" in self.attributes
            else None
        )
    ...
    def snmp_version(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.SNMP Version"]
            if "ShellFoundryTest_2.SNMP Version" in self.attributes
            else None
        )
    ...
    def enable_snmp(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.Enable SNMP"] if "ShellFoundryTest_2.Enable SNMP" in self.attributes else None
        )
    ...
    def disable_snmp(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.Disable SNMP"]
            if "ShellFoundryTest_2.Disable SNMP" in self.attributes
            else None
        )
    ...
    def console_server_ip_address(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.Console Server IP Address"]
            if "ShellFoundryTest_2.Console Server IP Address" in self.attributes
            else None
        )
    ...
    def console_user(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.Console User"]
            if "ShellFoundryTest_2.Console User" in self.attributes
            else None
        )
    ...
    def console_port(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.Console Port"]
            if "ShellFoundryTest_2.Console Port" in self.attributes
            else None
        )
    ...
    def console_password(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.Console Password"]
            if "ShellFoundryTest_2.Console Password" in self.attributes
            else None
        )
    ...
    def cli_connection_type(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.CLI Connection Type"]
            if "ShellFoundryTest_2.CLI Connection Type" in self.attributes
            else None
        )
    ...
    def cli_tcp_port(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.CLI TCP Port"]
            if "ShellFoundryTest_2.CLI TCP Port" in self.attributes
            else None
        )
    ...
    def backup_location(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.Backup Location"]
            if "ShellFoundryTest_2.Backup Location" in self.attributes
            else None
        )
    ...
    def backup_type(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.Backup Type"] if "ShellFoundryTest_2.Backup Type" in self.attributes else None
        )
    ...
    def backup_user(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.Backup User"] if "ShellFoundryTest_2.Backup User" in self.attributes else None
        )
    ...
    def backup_password(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.Backup Password"]
            if "ShellFoundryTest_2.Backup Password" in self.attributes
            else None
        )
    ...
    def system_name(self):
        ...
        """
        return (
            self.attributes["CS_GenericResource.System Name"] if "CS_GenericResource.System Name" in self.attributes else None
        )
...
class ResourcePort(object):
    ...
    def mac_address(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.ResourcePort.MAC Address"]
            if "ShellFoundryTest_2.ResourcePort.MAC Address" in self.attributes
            else None
        )
    ...
    def ipv4_address(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.ResourcePort.IPv4 Address"]
            if "ShellFoundryTest_2.ResourcePort.IPv4 Address" in self.attributes
            else None
        )
    ...
    def ipv6_address(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.ResourcePort.IPv6 Address"]
            if "ShellFoundryTest_2.ResourcePort.IPv6 Address" in self.attributes
            else None
        )
    ...
    def port_speed(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.ResourcePort.Port Speed"]
            if "ShellFoundryTest_2.ResourcePort.Port Speed" in self.attributes
            else None
        )
...
class GenericPowerPort(object):
    ...
    def model(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.GenericPowerPort.Model"]
            if "ShellFoundryTest_2.GenericPowerPort.Model" in self.attributes
            else None
        )
    ...
    def serial_number(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.GenericPowerPort.Serial Number"]
            if "ShellFoundryTest_2.GenericPowerPort.Serial Number" in self.attributes
            else None
        )
    ...
    def version(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.GenericPowerPort.Version"]
            if "ShellFoundryTest_2.GenericPowerPort.Version" in self.attributes
            else None
        )
    ...
    def port_description(self):
        ...
        """
        return (
            self.attributes["ShellFoundryTest_2.GenericPowerPort.Port Description"]
            if "ShellFoundryTest_2.GenericPowerPort.Port Description" in self.attributes
            else None
        )
